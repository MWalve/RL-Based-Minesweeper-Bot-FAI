...
class MineSweeper():
    ...
    def reset(self):
        self.grid = zeros((self.grid_width,self.grid_height),dtype=int)
        self.fog = zeros((self.grid_width,self.grid_height),dtype=int)
        self.state = zeros((self.grid_width,self.grid_height),dtype=int)
